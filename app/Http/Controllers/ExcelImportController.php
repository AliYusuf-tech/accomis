...
class ExcelImportController extends Controller
{
    ...
    {
        $cbo = Excel::import(new UsersImport, '/excel/cbosexcel.xlsx');
    ...
    {
        $cbo = Excel::import(new SpoImport, 'excel/SPOs.xlsx');
    ...
    {
        $cbo = Excel::import(new HealthFacilityImport, '/excel/health_facility.xlsx');
