            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="date" name="engage_date" class="form-control" placeholder="">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="date" name="establish_date" class="form-control" placeholder="">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" name="contact_address" class="form-control" placeholder="">
